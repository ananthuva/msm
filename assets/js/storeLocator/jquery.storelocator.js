...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		'distanceAlert'              : 60,
		'dataType'                   : 'json',
		'dataLocation'               : base_url + 'store/getStoresMap',
		'dataRaw'                    : null,
		'xmlElement'                 : 'marker',
		'listColor1'                 : '#ffffff',
		'listColor2'                 : '#eeeeee',
		...
		'dragSearch'                 : false,
		'infowindowTemplatePath'     : base_url +'assets/js/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'           : base_url +'assets/js/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath'  : base_url +'assets/js/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'        : base_url +'assets/js/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'             : null,
